...
// AWT (Abstract Window Toolkit) kelas warna
import java.awt.Color;
// AWT kelas kursor
import java.awt.Cursor;
// SQL classes impor sql
import java.sql.*;
...
public class LoginPage extends javax.swing.JFrame {
    ...
    public LoginPage() {
        // Swing components inisialisasi component
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/kliniklogin3.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/klinikals", "root", "");
