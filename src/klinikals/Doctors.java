...
public class Doctors extends javax.swing.JFrame {
    ...
    public Doctors() {
        initComponents();
        this.getContentPane().setBackground(new Color(0, 140, 140));
        // Center the frame 
        ...
        heading.setText("<html>"
                +"Welcome to <b>Klinikal</b>"
                + "</html>");

        doctdescp.setHorizontalAlignment(SwingConstants.RIGHT);
        doctdescp.setText("<html>"
                + "Aplikasi klinikal adalah perangkat lunak yang dirancang khusus untuk membantu klinik dalam mengelola"
                + " berbagai aspek operasionalnya secara efisien dan efektif. <br><br>"
                + "Aplikasi ini berfungsi sebagai pusat data terintegrasi yang menyimpan dan mengelola informasi"
                + " penting mengenai pasien, dokter, serta rekam medis. Dengan demikian, proses kerja di klinik"
                + " menjadi lebih terorganisir, akurat, dan cepat."
                + "</html>");
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(Doctorimage, javax.swing.GroupLayout.PREFERRED_SIZE, 409, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(58, 58, 58))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(Doctorimage, javax.swing.GroupLayout.PREFERRED_SIZE, 367, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(48, 48, 48))))
        );
